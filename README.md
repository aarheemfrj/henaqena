...
### 3️⃣ إعداد منصة الويب والإدارة (Next.js)

المنصة الرسمية والإدارة موجودة في `apps/web` ومبنية بـ Next.js + TypeScript، ومتّصلة بنفس API وPostgreSQL المستخدمين في التطبيق. المنفذ المعتمد محلياً وعلى الـ VPS هو `3100`، والدخول الإداري يتم بحساب المدير وجلسة آمنة من الخادم.
