...
المنصة الرسمية والإدارة مبنية بـ Next.js + TypeScript. مجلد `apps/admin` الحالي نموذج مؤقت فقط وسيتم استبداله تدريجياً. المنفذ المعتمد للمنصة محلياً وعلى الـ VPS هو `3100`.
